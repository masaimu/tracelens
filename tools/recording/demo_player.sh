...
case "${1:-}" in
  ...
  segintro_s3)   banner "S3" "段首预告 · 验收修返工" "1:43"; printf '\n\033[1;33m▌ 本段要看什么\033[0m\n\n   ① 一次真实发版的红 → 绿\n   ② 先找根因，不只补表面\n   ③ 用重新发一遍来验收\n\n   → 出错不靠肉眼排查，靠真实 run 验证\n';;
  ...
  agents_rules)   banner "S4" "给 AI 定约束 · AGENTS.md" "2:33"; printf '  \033[1;33m四条强制规则：\033[0m\n   1. 每次迭代后更新进度条文档\n   2. 同步更新里程碑和迭代文档\n   3. 完成后必须给实施报告 + 验收结论（自查逻辑漏洞 / Bug）\n   4. 必须 review 产品传播内容\n\n'; show_n AGENTS.md 116 128 "开发约束 · 四件套验证命令";;
  ...
  endcard)        banner "FIN" "有文档 · 有验收 · 我来验" "4:15"; printf '\n\n   \033[1;36m用文档工程治理 AI，让它跑、我来验。\033[0m\n\n';;
