...
LABEL = {
 ...
 "progress_bar":"83% 进度条(progress)",
 "segintro_s2b":"预告页·一句话 prompt 闭环", "prompt_short":"一句话短 prompt",
 "iter_doc":"iteration-15 本期目标", "iter_report":"iteration-15 实施报告",
 "segintro_s3":"预告页·验收钉返工", "dup_fixture":"重复 spanId fixture",
 "prompt_dup":"触发返工的 prompt","test_code":"critical_path.rs 测试代码",
 "run_test":"cargo test --bin → 绿",
 ...
 "progress_bar_end":"83% 进度条","gitlog":"git log","endcard":"收尾卡",
}
